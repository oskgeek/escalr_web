...
function initScripts(){
	...
	$.getScript("external/velocity/velocity.min.js",function(){
		$.getScript("external/velocity/velocity.ui.min.js", function(){
			$.getScript("external/quttons/quttons.js", function(){
					var $footer = $('.footer');
	...
	if (!$.event.special.inview){
		$.getScript("external/inview/jquery.inview.js")
	}
}
...
function insertPopup(){
	...
	$('<img>', {
		...
		'src': "images/popup/author-photo.jpg",
		'alt': "Author photo"
...
function initQutton(){
	...
	quttonUpload.init({
			icon: 'images/popup/icon-popup.svg',
